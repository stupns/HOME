...
3. Написати функцію, що приймає список, 2 аргумент розмір. Результат повинен розбитим на вложений листи по розмірах.
4. Апгрейднути фнкцію по валідації від'ємного розміру.
5. Створити функцію для валідації від'ємного розміру.
6. Пробігтися по чанкам і прiнтанути всі групи окремо.
...
def square_first_two_chunks(chunks):
    pass
...
pytest.main(['-rpP', '..\\TESTS\\TESTS_FUNCTIONS\\TESTS_TASK_EXERCISE_1.py'])